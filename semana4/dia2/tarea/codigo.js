...
function letraCancion(){
    ...
    }else if(eleccion === "adultsTalking"){
        titulo.textContent = "The Adults are Talking - The Strokes"
        parrafo.innerHTML = `They've been sayin', "You're sophisticated"<br>
    ...
    }else if(eleccion === "selfless"){
        titulo.textContent = "Selfless - The Strokes"
        parrafo.innerHTML = `Can the dark side light my way? Oh, yeah, yeah<br>
    ...
    }else if(eleccion === "creep"){
        titulo.textContent = "Creep - Radiohead"
        parrafo.innerHTML = `When you were here before<br>
    ...
    }else if(eleccion === "wonderwall"){
        titulo.textContent = "Wonderwall - Oasis"
        parrafo.innerHTML = `Today is gonna be the day<br>
